...
const PhoneCarded = ({ phone }) => {
    ...
    const handleAddToFavorites = () =>{
        ...
        const addedFavoritesItems = [];

        const favoriteItems = JSON.parse(localStorage.getItem('favorites'));

        if(!favoriteItems){

            addedFavoritesItems.push(phone);

            localStorage.setItem("favorites",JSON.stringify(addedFavoritesItems));
            ...
            if(!isExits){
                addedFavoritesItems.push(...favoriteItems,phone);
                localStorage.setItem("favorites",JSON.stringify(addedFavoritesItems));
                swal("Good job!", "You clicked the button!", "success");  
